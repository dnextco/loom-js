...
var User = /** @class */ (function (_super) {
    ...
    User.createUser = function (wallet, dappchainPrivateKey, plasmaAddress, dappchainEndpoint, eventsEndpoint, dbPath, startBlock, chainId) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var database, ethPlasmaClient, protocol, writerSuffix, readerSuffix, writer, reader, dAppClient, privKey, pubKey, callerAddress, addressMapper, ethAddress, _a, _b, _c, _d, dAppPlasmaClient, defaultAccount;
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        dAppClient = new __1.Client(chainId || 'default', writer, reader);
                        if (dappchainPrivateKey === null) {
                            privKey = __1.CryptoUtils.generatePrivateKey();
                        }
                        else {
                            privKey = __1.CryptoUtils.B64ToUint8Array(dappchainPrivateKey);
                        }
                        pubKey = __1.CryptoUtils.publicKeyFromPrivateKey(privKey);
                        dAppClient.txMiddleware = [
                            new __1.NonceTxMiddleware(pubKey, dAppClient),
                            new __1.SignedTxMiddleware(privKey)
                        ];
                        callerAddress = new __1.Address(chainId || 'default', __1.LocalAddress.fromPublicKey(pubKey));
                    ...
                    case 1:
                        addressMapper = _e.sent();
                        _a = __1.Address.bind;
                        _b = [void 0, 'eth'];
                        _d = (_c = __1.LocalAddress).fromHexString;
                        return [4 /*yield*/, wallet.getAddress()];
                    case 2:
                        ethAddress = new (_a.apply(__1.Address, _b.concat([_d.apply(_c, [_e.sent()])])))();
